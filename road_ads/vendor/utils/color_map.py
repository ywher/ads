color_map = {
    # public driving segmentation datasets
    ...
    # public synthetic segmentation datasets
    'syn_city': {
        0:  (128,  64, 128),    # road
        1:  (244,  35, 232),    # sidewalk
        2:  ( 70,  70,  70),    # building
    ...
    'parking_fisheye': {
        0:  (  0,   0,   0),    # background
        1:  (  0,   0, 142),    # parking line
        2:  (220,  20,  60),    # white line
        3:  (111,  74,   0),    # yellow line
        4:  (128,  64, 128),    # zebra crossing
        5:  (250, 170, 160),    # arrow
        6:  (250, 170,  30),    # slope
        7:  (220, 200,   0),    # other
    },
